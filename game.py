...
def presentation_clic(event): #Interactions clic liées à l'arrivée du joueur dans le manoir
    ...
    global bool_2,compt,compt1,k,bool_fin,Perdu1,Perdu2
...
def clic2(event) :
    global can1,invitation,fantome1,perso5,bool_clic2,bool_bquitter,notif,bool_clic3,bool_invitation,notif2,n,bouton,bool_5,compt2,k,bindice1,bool_indice,bool_bindice,coffre_ouvert
...
def embarquement():
    ...
    if Perdu2==True:
         ...
         notif("Mais tu n'as pas trouvé l'invitation ! Elle etait innocente ","white")
    if Perdu1==True:
         can1.itemconfig(image_fond,image=perdu)
